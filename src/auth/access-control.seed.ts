...
export const CORE_PERMISSIONS: PermissionSeed[] = [
  ...
  {
    code: 'filierestats:read',
    label: 'Lire les statistiques de filiere',
    description:
      'Permet de consulter les statistiques des filieres cacao et cafe.',
  },
  {
    code: 'filierestats:create',
    label: 'Creer une statistique de filiere',
    description: 'Permet de creer une statistique de filiere cacao ou cafe.',
  },
  {
    code: 'filierestats:update',
    label: 'Modifier une statistique de filiere',
    description: 'Permet de modifier une statistique de filiere existante.',
  },
  {
    code: 'filierestats:delete',
    label: 'Supprimer une statistique de filiere',
    description: 'Permet de supprimer une statistique de filiere existante.',
  },
  {
    code: 'organigramme:read',
    label: "Lire l'organigramme",
    description: "Permet de consulter l'image de l'organigramme.",
  },
  {
    code: 'organigramme:create',
    label: "Creer l'organigramme",
    description: "Permet de televerser une nouvelle image d'organigramme.",
  },
  {
    code: 'organigramme:update',
    label: "Modifier l'organigramme",
    description: "Permet de modifier l'organigramme existant.",
  },
  {
    code: 'organigramme:delete',
    label: "Supprimer l'organigramme",
    description: "Permet de supprimer une image d'organigramme.",
  },
  {
    code: 'cooperatives:read',
    label: 'Lire les cooperatives',
    description: 'Permet de consulter les cooperatives.',
  },
  {
    code: 'cooperatives:create',
    label: 'Creer une cooperative',
    description: 'Permet de creer une nouvelle cooperative.',
  },
  {
    code: 'cooperatives:update',
    label: 'Modifier une cooperative',
    description: 'Permet de modifier une cooperative existante.',
  },
  {
    code: 'cooperatives:delete',
    label: 'Supprimer une cooperative',
    description: 'Permet de supprimer une cooperative existante.',
  },
  {
    code: 'controleursqualite:read',
    label: 'Lire les controleurs qualite',
    description: 'Permet de consulter les controleurs qualite.',
  },
  {
    code: 'controleursqualite:create',
    label: 'Creer un controleur qualite',
    description: 'Permet de creer un nouveau controleur qualite.',
  },
  {
    code: 'controleursqualite:update',
    label: 'Modifier un controleur qualite',
    description: 'Permet de modifier un controleur qualite existant.',
  },
  {
    code: 'controleursqualite:delete',
    label: 'Supprimer un controleur qualite',
